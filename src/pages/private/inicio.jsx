...
const Inicio = ({
  ...
  const modulos = [
    { text: 'Início', icon: <HomeIcon />, rota: '/inicio', action: () => navigate('/inicio') },
    { text: 'Usuário', icon: <PersonIcon />, rota: '/usuarios', action: () => navigate('/usuarios') },
    { text: 'Vendas', icon: <AssessmentIcon />, rota: '/vendas', action: () => navigate('/vendas') },
    { text: 'Pdv Rápido', icon: <StorefrontIcon />, rota: '/pdv', action: () => navigate('/pdv') },
    { text: 'Contas', icon: <ReportProblemIcon />, rota: '/contas', action: () => navigate('/contas') },
